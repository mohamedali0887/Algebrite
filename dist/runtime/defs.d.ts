...
export declare type PrintMode = typeof PRINTMODE_LATEX | typeof PRINTMODE_2DASCII | typeof PRINTMODE_COMPUTER | typeof PRINTMODE_HUMAN | typeof PRINTMODE_LIST;
declare class Defs {
    printMode: PrintMode;
...
export declare type U = Cons | Num | Double | Str | Tensor | Sym;
...
export declare type NumbericTensor = Double | Num | Tensor<NumbericTensor>;
