...
function Eval_transpose(p1) {
    ...
    let arg2 = defs_js_1.Constants.one;
    let arg3 = (0, bignum_js_1.integer)(2);
    if ((0, defs_js_1.cddr)(p1) !== (0, symbol_js_1.symbol)(defs_js_1.NIL)) {
        arg2 = (0, eval_js_1.Eval)((0, defs_js_1.caddr)(p1));
        arg3 = (0, eval_js_1.Eval)((0, defs_js_1.cadddr)(p1));
    }
...
function transpose(p1, p2, p3) {
    let t = 0;
    const ai = Array(defs_js_1.MAXDIM).fill(0);
    const an = Array(defs_js_1.MAXDIM).fill(0);
    ...
    if (((0, is_js_1.isplusone)(p2) && (0, is_js_1.isplustwo)(p3)) || ((0, is_js_1.isplusone)(p3) && (0, is_js_1.isplustwo)(p2))) {
    ...
    if ((0, defs_js_1.istranspose)(p1)) {
        const innerTranspSwitch1 = (0, defs_js_1.car)((0, defs_js_1.cdr)((0, defs_js_1.cdr)(p1)));
        const innerTranspSwitch2 = (0, defs_js_1.car)((0, defs_js_1.cdr)((0, defs_js_1.cdr)((0, defs_js_1.cdr)(p1))));
        if (((0, misc_js_1.equal)(innerTranspSwitch1, p3) && (0, misc_js_1.equal)(innerTranspSwitch2, p2)) ||
            ((0, misc_js_1.equal)(innerTranspSwitch2, p3) && (0, misc_js_1.equal)(innerTranspSwitch1, p2)) ||
            ((0, misc_js_1.equal)(innerTranspSwitch1, (0, symbol_js_1.symbol)(defs_js_1.NIL)) &&
                (0, misc_js_1.equal)(innerTranspSwitch2, (0, symbol_js_1.symbol)(defs_js_1.NIL)) &&
                (((0, is_js_1.isplusone)(p3) && (0, is_js_1.isplustwo)(p2)) || ((0, is_js_1.isplusone)(p2) && (0, is_js_1.isplustwo)(p3))))) {
    ...
    if (defs_js_1.defs.expanding && (0, defs_js_1.isadd)(p1)) {
        ...
        return p1
            .tail()
            .reduce((a, b) => (0, add_js_1.add)(a, transpose(b, p2, p3)), defs_js_1.Constants.zero);
    }
    // if operand is a multiplication then distribute (if we are in expanding mode)
    if (defs_js_1.defs.expanding && (0, defs_js_1.ismultiply)(p1)) {
        // add the dimensions to switch but only if they are not the default ones.
        return p1
            .tail()
            .reduce((a, b) => (0, multiply_js_1.multiply)(a, transpose(b, p2, p3)), defs_js_1.Constants.one);
    }
    ...
    if (defs_js_1.defs.expanding && (0, defs_js_1.isinnerordot)(p1)) {
        ...
        accumulator.reverse();
        return accumulator.reduce((acc, p) => (0, inner_js_1.inner)(acc, transpose(p[0], p[1], p[2])), (0, symbol_js_1.symbol)(defs_js_1.SYMBOL_IDENTITY_MATRIX));
    }
    if (!(0, defs_js_1.istensor)(p1)) {
        if (!(0, is_js_1.isZeroAtomOrTensor)(p1)) {
            ...
            // parameters
            if ((!(0, is_js_1.isplusone)(p2) || !(0, is_js_1.isplustwo)(p3)) &&
                (!(0, is_js_1.isplusone)(p3) || !(0, is_js_1.isplustwo)(p2))) {
                return (0, list_js_1.makeList)((0, symbol_js_1.symbol)(defs_js_1.TRANSPOSE), p1, p2, p3);
            }
            return (0, list_js_1.makeList)((0, symbol_js_1.symbol)(defs_js_1.TRANSPOSE), p1);
        }
    ...
    if (l < 1 || l > ndim || m < 1 || m > ndim) {
        (0, run_js_1.stop)('transpose: index out of range');
    }
    l--;
    m--;
