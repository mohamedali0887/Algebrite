...
import { caddr, cadr, Constants, E, iscons, ispower, istensor, } from './defs.js';
import { symbol } from "./symbol.js";
// returns true if expr p contains expr q, otherwise returns false
export function Find(p, q) {
    if (equal(p, q)) {
        return true;
    }
    if (istensor(p)) {
...
export function findPossibleClockForm(p, p1) {
...
export function findPossibleExponentialForm(p) {
