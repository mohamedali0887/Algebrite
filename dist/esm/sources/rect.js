import { ASSUME_REAL_VARIABLES, cadr, Constants, COS, isadd, ismultiply, issymbol, SIN, YYRECT } from '../runtime/defs.js';
...
export function Eval_rect(p1) {
    return rect(Eval(cadr(p1)));
}
export function rect(p1) {
    const input = p1;
    if (DEBUG_RECT) {
