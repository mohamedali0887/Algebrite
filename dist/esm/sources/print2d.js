import { ADD, breakpoint, caar, caddr, cadr, car, cdr, Constants, DERIVATIVE, DOUBLE, E, FACTORIAL, INDEX, isadd, iscons, isdouble, isfactorial, ismultiply, isNumericAtom, ispower, isrational, isstr, issymbol, istensor, MULTIPLY, NUM, POWER, SETQ, } from '../runtime/defs.js';
...
export function print2dascii(p) {
    yindex = 0;
    level = 0;
    emit_x = 0;
    emit_top_expr(p);
