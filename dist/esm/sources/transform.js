import { breakpoint, caddr, cadr, car, cdddr, cddr, cdr, Constants, DEBUG, iscons, isNumericAtom, METAA, METAB, METAX, NIL, SYMBOL_A_UNDERSCORE, SYMBOL_B_UNDERSCORE, SYMBOL_X_UNDERSCORE, noexpand, } from '../runtime/defs.js';
...
//define B p6
//define C p7
export function transform(F, X, s, generalTransform) {
    if (DEBUG) {
