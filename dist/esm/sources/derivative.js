import { ABS, ARCCOS, ARCCOSH, ARCSIN, ARCSINH, ARCTAN, ARCTANH, BESSELJ, BESSELY, caddr, cadr, car, cdr, Constants, COS, COSH, DERIVATIVE, ERF, ERFC, HERMITE, INTEGRAL, isadd, iscons, isNumericAtom, issymbol, istensor, LOG, MULTIPLY, NIL, POWER, SECRETX, SGN, SIN, SINH, TAN, TANH } from '../runtime/defs.js';
...
//define X p4
//define N p5
export function Eval_derivative(p1) {
...
export function derivative(p1, p2) {
    if (isNumericAtom(p2)) {
