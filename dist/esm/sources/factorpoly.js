...
import { Constants, DEBUG, issymbol, noexpand } from '../runtime/defs.js';
...
import { isfloating, isnegativeterm, ispolyexpandedform, isZeroAtomOrTensor, } from './is.js';
import { divide, multiply, multiply_noexpand, negate, negate_noexpand, reciprocate, } from './multiply.js';
...
//define RESULT p7
//define FACTOR p8
export function factorpoly(POLY, X) {
    if (!Find(POLY, X)) {
        return POLY;
    }
