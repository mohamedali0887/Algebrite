import { car, cdr, DEBUG, EVAL, FUNCTION, iscons, isNumericAtom, isstr, issymbol, istensor, SYMBOL_D } from '../runtime/defs.js';
...
*/
export function Eval_user_function(p1) {
    // Use "derivative" instead of "d" if there is no user function "d"
    if (DEBUG) {
        console.log(`Eval_user_function evaluating: ${car(p1)}`);
    }
    if (car(p1) === symbol(SYMBOL_D) &&
    ...
    if (car(bodyAndFormalArguments) !== symbol(FUNCTION) ||
