...
class Defs {
    ...
    expanding = false;
    evaluatingAsFloats = false;
    evaluatingPolar = false;
    esc_flag = false;
    trigmode = 0;
    out_count = 0;
    test_flag = false;
...
export class Tensor extends BaseAtom {
    ...
    dim = []; // dimension length, for each dimension
    elem = []; // an array containing all the data
    get nelem() {
...
export class Constants {
    static one = new Num(bigInt(1));
    static oneAsDouble = new Double(1.0);
    static negOne = new Num(bigInt(-1));
    static negOneAsDouble = new Double(-1.0);
    static zero = new Num(bigInt(0));
    static zeroAsDouble = new Double(0.0);
    static piAsDouble = new Double(Math.PI);
    // i is the square root of -1 i.e. -1 ^ 1/2
    static imaginaryunit;
    static One() {
